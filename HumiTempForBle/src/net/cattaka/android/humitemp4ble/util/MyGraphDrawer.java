...
import net.cattaka.android.humitemp4ble.util.GraphDrawer.GraphAreaInfo;
import net.cattaka.android.humitemp4ble.util.GraphDrawer.GraphValue;
import net.cattaka.android.humitemp4ble.util.GraphDrawer.GridInfo;
import net.cattaka.android.humitemp4ble.util.GraphDrawer.GridLine;
...
public class MyGraphDrawer {
    ...
    public MyGraphDrawer(Context context, DbHelper dbHelper, long deviceId) {
        super();
    ...
    private Bitmap createImage(GraphTextLabelInfo gtlInfo, Date from, Date to, long intervalX,
        ...
        List<HumiTempModel> dtoList = dbHelper.findHumiTempModel(from, to, mDeviceId);
