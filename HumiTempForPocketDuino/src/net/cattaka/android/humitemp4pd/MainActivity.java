...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    private IActiveGeppaServiceListener mGeppaServiceListener = new IActiveGeppaServiceListener.Stub() {
        public void onDeviceStateChanged(DeviceState deviceState, DeviceEventCode eventCode,
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder binder) {
            mService = IActiveGeppaService.Stub.asInterface(binder);
            try {
                mService.registerServiceListener(mGeppaServiceListener);
