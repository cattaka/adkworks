...
import net.cattaka.droiball.view.PoseListAdapter;
import net.cattaka.droiball.view.PoseListAdapter.PoseListAdapterListener;
...
public class ActionEditActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.addButton) {
            ...
            DroiballDatabase database = new DroiballDatabase(this);
