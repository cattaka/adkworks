...
import net.cattaka.android.foxkehrobo.view.ActionListAdapter.ActionListAdapterListener;
...
public class ActionListEditActivity extends Activity implements View.OnClickListener {
    ...
    private FoxkehRoboDatabase mDroiballDatabase;
    ...
    public void onResume() {
        ...
        { // opening DB
            ...
            if (mDroiballDatabase == null) {
                mDroiballDatabase = new FoxkehRoboDatabase(this);
            }
        }
